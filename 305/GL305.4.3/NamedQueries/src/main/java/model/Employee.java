...
@NamedQueries({
        @NamedQuery(name = "getEmployeeById", query = "select e.name,e.salary," +
                "e.job from Employee e where id=:id"),
        @NamedQuery(name = "getAllDepartments", query = "from Employee"),
        @NamedQuery(name = "findEmployeeByName", query = "from Employee e where " +
                "e.name = :name"),
        @NamedQuery(name = "employeeDeptAlias", query = "select e, e.officeCode , " +
                "e.name, " +
                "CASE " +
